        ...
        <div className='personal__info__container'>
          ...
          <form>
            ...
            <div className='form__item'>
              ...
              <input type='email' placeholder='Doe'></input>
            </div>
            <div className='form__item'>
              <label>Phone Number <b>*</b></label>
              <input type='email' placeholder='+491234567890'></input>
            </div>
            <div className='form__item'>
              <label>Age <b>*</b></label>
              <input type='name' placeholder='18'></input>
            </div>
            <div className='form__item'>
            ...
            <div className='form__item'>
              ...
              <input type='email' placeholder='Plac Konesera 8'></input>
            </div>
            <div className='form__item'>
              <label>City <b>*</b></label>
              <input type='name' placeholder='Warsaw'></input>
            </div>
            <div className='form__item'>
              <label>Zip Code <b>*</b></label>
              <input type='email' placeholder='00-368'></input>
            </div>
          </form>
